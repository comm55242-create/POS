...
<head>
    ...
    <link rel="icon" type="image/png" href="img/logo_circle.png?v=2">
...
<body>
    ...
    <div class="filters-container">
        <div class="tabs">
            ...
            <div style="width: 1px; height: 24px; background: var(--card-border); margin: 0 4px; align-self: center;"></div>
            
            <button class="tab-btn" data-filter="status-matched" style="color: #4ade80; border: 1px solid rgba(74, 222, 128, 0.3);">Matched</button>
            <button class="tab-btn" data-filter="status-not-matched" style="color: #f87171; border: 1px solid rgba(248, 113, 113, 0.3);">Not Matched</button>
        </div>
            ...
            <div class="store-card" id="card-<?= $code ?>" data-region="<?= $region ?>" onclick="handleCardClick(event, '<?= $code ?>', '<?= addslashes($name) ?>')">
                <div class="card-body">
                    ...
                    <div class="card-metrics-grid">
                        <div class="metric-cell">
                            ...
                            <div class="metric-cell-value invoice-count skeleton" id="count-<?= $code ?>">&nbsp;</div>
                            <div class="sync-time-mini" id="sync-time-inv-<?= $code ?>"></div>
                        </div>
                        <div class="metric-cell">
                            <div class="metric-cell-label">
                            ...
                            <div class="metric-cell-value alert-count skeleton" id="alerts-<?= $code ?>">&nbsp;</div>
                            <div class="sync-time-mini" id="sync-time-alert-<?= $code ?>"></div>
                        </div>
                        <div class="metric-cell" style="grid-column: span 2; align-items: center; text-align: center;">
                            <div class="metric-cell-label" style="justify-content: center;">
                                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4"></path></svg>
                                Handover
                            </div>
                            <div class="metric-cell-value handover-count skeleton" id="handover-<?= $code ?>">&nbsp;</div>
                            <div class="sync-time-mini" id="sync-time-mgr-<?= $code ?>"></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-footer">
                    <div class="sync-info">
                        ...
                        <span class="sync-info-time" id="sync-time-<?= $code ?>">Checking...</span>
                        <span class="match-status" id="match-status-<?= $code ?>"></span>
                    </div>
